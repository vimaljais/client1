...
export default function FormFour({Age, nextStep, values, handleChange, Amount}) {
    ...
    function Continue(e){
      ...
      return (
        <Card>
          ...
          <SelectWrap>
            <AgeWrap>
                <AgeSelect name="age"  onChange={handleChange}>
                    {Age.map((data,index)=>(
            ...
            <AgeWrap>
                <AgeSelect name="cover_amount" onChange={handleChange}>
