declare const _default: <T extends Partial<{
    required: import("../types").Message | import("../types").ValidationRule<boolean>;
...
}>>(options?: T | undefined, mounted?: boolean | undefined) => boolean | string[] | import("../types").ValidationValueMessage<boolean> | import("../types").ValidationRule<string | number> | import("../types").ValidationRule<RegExp> | import("../types").Validate<any> | Record<string, import("../types").Validate<any>> | undefined;
